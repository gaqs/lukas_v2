    ...
    type: function(contentType, invalid){
      ...
      if( typeof contentType == 'function' ){
        ...
        isValid = function(type){
            console.info("formato= "+ type );
            //console.log("formato permitido= "+ contentType);
            //console.log("ubicacion= "+ contentType.indexOf( type  ));
            //original -> return ~type.indexOf(contentType);
