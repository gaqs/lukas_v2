        ...
        <div class="container d-grid">
          <div class="row justify-content-center">
            <div class="col-7 text-center align-self-center">
              ...
              <h5 class="text-white">Lista con los Seleccionados el 18 de Julio 2023</h5>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container my-5">
      ...
      <div class="row">
        ...
        <div class="col-md-5 text-end">
          <h4 class="ms-3">Video tutorial 2022</h4>
        ...
        <div class="col-md-4 mb-3">
          <div class="card overflow-hidden card_concurso">
            ...
            <div class="card-body" style="z-index:1;">
              ...
              <a href="<?= base_url('home/briefing?survey_id=6'); ?>" class="btn btn-lg btn-primary">Postular <i class="fa-solid fa-angles-right"></i></a>
            </div>
          </div>
        </div>
        <div class="col-md-4 mb-3">
          <div class="card overflow-hidden card_concurso">
            ...
            <div class="card-body" style="z-index:1;">
              ...
              <a href="<?= base_url('home/briefing?survey_id=7'); ?>" class="btn btn-lg btn-primary">Postular <i class="fa-solid fa-angles-right"></i></a>
            </div>
          </div>
        </div>
        <div class="col-md-4 mb-3">
          ...
          <i class="fa-solid fa-fish back_icon"></i>
            <div class="card-body" style="z-index:1;">
              <h4 class="card-title">Categoría<br>Pesca</h4>
