				    					...
				    					<div class="card-body">
				    						...
				    						<hr>
												<div class="alert alert-warning" role="alert">
													<p>*ESTOS DATOS NO SON OBLIGATORIOS. Pero de querer postular en un concurso asociado a empresas, estos datos serán solicitados. </p>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="edit_pass_modal_label">Cambiar contraseña</h5>
				...
				<div class="modal-body">
					...
					<div class="row">
						<form id="change_password_form">
							<div class="col-12">
								<div class="mb-3">
									<label for="input_old_password" class="form-label">Contraseña actual</label>
								...
								<div class="mb-3">
									<label for="repeat_new_password" class="form-label">Confirmar nueva contraseña</label>
									<span class="fas fa-unlock-alt icon-input"></span>
