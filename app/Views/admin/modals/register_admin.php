<form class="" action="<?= base_url('admin/admins'); ?>" method="post">
      ...
      <div class="row mb-2">
        ...
        <div class="col-md-6">
          ...
          <div class="input-group mb-3">
            <span class="fas fa-user icon-input" style="z-index:9;"></span>
  ...
  <div class="row mt-3">
      <div class="col-md-12 text-end">
         ...
         <button type="submit" class="btn btn-primary submit_something" name="button" value="0"><i class="fas fa-sync"></i> Registrar</button>
      </div>
   </div>
</form>
