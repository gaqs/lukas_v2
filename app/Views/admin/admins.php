  ...
  <main class="main mt-3">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-3">
          <button type="button" id="edit_admin" class="btn btn-success mb-3" name="button" value="0">
              ...
              echo '<tr>
                      ...
                      <td class="text-center">
                        <div class="btn-group" role="group" aria-label="Acción">
                          <button type="button" id="edit_admin" class="btn btn-primary" value="'.$admin[$i]['id'].'" ><i class="fa-solid fa-user-pen"></i></button>
...
<div class="modal fade" id="admin_modal" tabindex="-1" aria-labelledby="admin_modal_label" aria-hidden="true">
  <div class="modal-dialog px-5 pt-0">
